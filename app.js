...
const DEFAULT_SITES = [
    ...
    {
        id: "pharmgenix-xyz",
        name: "PharmGenix (pharmgenix.xyz)",
        url: "https://pharmgenix.xyz",
        category: "ai",
        status: "active",
        desc: "웹사이트 상세 설명 및 주요 기능을 입력해 주세요.",
        tags: ["pharmgenix", "AI"],
    ...
    {
        id: "voxiai-xyz",
        name: "VoxiAI (voxiai.xyz)",
        url: "https://voxiai.xyz",
        category: "ai",
        status: "active",
        desc: "웹사이트 상세 설명 및 주요 기능을 입력해 주세요.",
        tags: ["voxiai", "AI Voice"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "가격 미정",
    ...
    {
        id: "voiscely-xyz",
        name: "Voiscely (voiscely.xyz)",
        url: "https://voiscely.xyz",
        category: "ai",
        status: "active",
        desc: "웹사이트 상세 설명 및 주요 기능을 입력해 주세요.",
        tags: ["voiscely", "AI Agent"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "가격 미정",
    ...
    {
        id: "callock-ai-kr",
        name: "Callock AI (callock.ai.kr)",
        url: "https://callock.ai.kr",
        category: "ai",
        status: "active",
        desc: "웹사이트 상세 설명 및 주요 기능을 입력해 주세요.",
        tags: ["callock", "Security"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "가격 미정",
    ...
    {
        id: "aioscore-kr",
        name: "AIO Score (aioscore.kr)",
        url: "https://aioscore.kr",
        category: "ai",
        status: "active",
        desc: "웹사이트 상세 설명 및 주요 기능을 입력해 주세요.",
        tags: ["aioscore", "Analytics"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "가격 미정",
