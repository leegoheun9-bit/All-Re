...
const DEFAULT_SITES = [
    ...
    },
    {
        ...
        category: "ai",
        status: "active",
        desc: "AI 기반 차세대 바이오 제약 R&D 솔루션. 유전자 시퀀싱 데이터와 단백질 구조 모형을 딥러닝으로 학습하여 신약 후보 물질의 유효성과 독성을 정밀 예측하는 차세대 헬스케어 플랫폼입니다.",
        tags: ["Bio AI", "Healthcare", "Deep Learning", "Drug Discovery", "SaaS"],
        ...
        founderName: "Vitalii Dodonov",
        momGrowth: 0,
        domainExpires: "2027-06-30",
        sslExpires: "2027-06-30",
        gaId: "G-PHARMGENIX"
    },
    {
        id: "voxiai-xyz",
        ...
        category: "ai",
        status: "active",
        desc: "초감정 초저지연 다국어 AI 음성 생성 솔루션. 감정 표현이 풍부한 자연스러운 음성 합성(TTS) 및 성우 목소리 클로닝 기능을 제공하여 미디어 콘텐츠 제작을 혁신합니다.",
        tags: ["AI Voice", "TTS", "Audio Synthesizer", "Voice Cloning", "Vocal AI"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "$25k",
        niche: "AI Voice & Audio Synthesizer",
        logoIcon: "🎙️",
        founderName: "Vitalii Dodonov",
        momGrowth: 0,
        domainExpires: "2027-07-15",
        sslExpires: "2027-07-15",
        gaId: "G-VOXIAIXYZ"
    },
    {
        id: "voiscely-xyz",
        ...
        category: "ai",
        status: "active",
        desc: "24/7 지능형 실시간 음성 에이전트 및 고객 상담 자동화 플랫폼. 양방향 음성 대화 엔진을 통해 고객 응대, 예약 관리, 해피콜 및 outbound 영업 통화를 인공지능이 자동 처리합니다.",
        tags: ["AI Voice Call", "Conversational AI", "Speech Recognition", "Callbot", "Customer Agent"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "$28k",
        ...
        founderName: "Vitalii Dodonov",
        momGrowth: 0,
        domainExpires: "2027-08-01",
        sslExpires: "2027-08-01",
        gaId: "G-VOISCELYX"
    },
    {
        id: "callock-ai-kr",
        ...
        category: "ai",
        status: "active",
        desc: "실시간 보이스피싱 및 딥페이크 음성 사기 방지 보안 플랫폼. 통화 음성 신호의 고주파 스펙트럼과 변조 패턴을 실시간 분석하여 보이스피싱과 스팸 전화 위험을 차단합니다.",
        tags: ["Security AI", "Call Protection", "Voice Anti-Phishing", "Spam Filter", "Deepfake Detect"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "2,500만원",
        niche: "AI Call Security & Anti-Phishing",
        logoIcon: "🔒",
        founderName: "Vitalii Dodonov",
        momGrowth: 0,
        domainExpires: "2027-05-20",
        sslExpires: "2027-05-20",
        gaId: "G-CALLOCKAI"
    },
    {
        id: "aioscore-kr",
        ...
        category: "ai",
        status: "active",
        desc: "차세대 AI 검색 엔진(Perplexity, ChatGPT, Gemini, Claude 등)의 브랜드 및 웹사이트 노출 지수(AIO Score) 측정 서비스. AI 답변 엔진에서의 브랜드점유율과 가시성을 실시간 인덱싱하여 분석 리포트를 제공합니다.",
        tags: ["AIO", "SEO AI", "AI Search Index", "Analytics", "Brand Score"],
        dateAdded: "2026-08-18T10:20:00Z",
        monthlyRevenue: 0,
        monthlyVisitors: 0,
        askingPrice: "3,000만원",
        niche: "AI Search Engine Optimization (AIO)",
        logoIcon: "📈",
        founderName: "Vitalii Dodonov",
        momGrowth: 0,
        domainExpires: "2027-09-10",
        sslExpires: "2027-09-10",
        gaId: "G-AIOSCOREK"
    }
];
        ...
        try {
            ...
            DEFAULT_SITES.forEach(defaultSite => {
                ...
                if (existingIndex === -1) {
                    ...
                    needsSave = true;
                } else if (["pharmgenix-xyz", "voxiai-xyz", "voiscely-xyz", "callock-ai-kr", "aioscore-kr"].includes(defaultSite.id)) {
                    sites[existingIndex] = { ...defaultSite };
                    needsSave = true;
                }
            });
            sites.forEach(site => {
